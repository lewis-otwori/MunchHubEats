...
const Card = ({data}) => {
  ...
  return (
    <div className='restaurantsC'>
   {restaurants.map((restaurants)=> (
    <div className='restaurants-card' key={restaurants.id}>
   <AdvancedImage cldImg={cld.image(restaurants.image).resize(fill().width(250).height(250))} />
  ...
  return (
    <React.Fragment>    
        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <h1>munezz</h1>
            {renderRestaurantsCards(restaurants.filter((restaurants) => restaurants.type === 'restaurant1'))}
            <div class="p-5">
                {/* <a href="#">
